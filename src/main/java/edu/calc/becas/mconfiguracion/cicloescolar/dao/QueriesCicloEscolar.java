...
public class QueriesCicloEscolar {
    ...
    public static final String QRY_UPDATE = "UPDATE CICLO_ESCOLAR SET DESCRIPCION_CICLO = ?, PERIODO_ACTUAL = ? WHERE ID_CICLO_ESCOLAR = ?";

    public static final String QRY_UPDATE_STATUS = "UPDATE CICLO_ESCOLAR SET PERIODO_ACTUAL = \"N\"";
