...
final class QueriesActividades {
    ...
    static final String QRY_ADD_HORA_ACTIVIDAD = "INSERT INTO HORARIO_ACTIVIDAD (ID_ACTIVIDAD, HORA, AM_PM, NUMERO_ALUMNOS, ID_USUARIO, CVE_PERIODO, DESC_PERIDODO, ESTATUS,AGREGADO_POR, FECHA_CREACION) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";

    static final String QRY_UPDATE_HORA_ACTIVIDAD = "UPDATE HORARIO_ACTIVIDAD SET HORA = ?, AM_PM = ?, " +
            "NUMERO_ALUMNOS = ?, ID_USUARIO = ?, ESTATUS = ? WHERE ID_HORARIO_ACTIVIDAD = ?";
