...
public final class DecryptUtil {
    ...
    public static String decrypt(String dataEncrypt, String secretKey, String tipoDato) throws Exception {
        byte[] cipherData = Base64.getDecoder().decode(dataEncrypt);
        ...
        try {
            ...
            e.printStackTrace();
            throw new Exception("Error al desencriptar " + tipoDato);
        }
    }
