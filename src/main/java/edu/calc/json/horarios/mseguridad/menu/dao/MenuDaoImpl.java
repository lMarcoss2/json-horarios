...
public class MenuDaoImpl extends BaseDao implements MenuDao {
    ...
    private void getChild(List<Menu> menu, String username) {
        for (Menu menu1 : menu) {
            menu1.setChilds(
                    this.jdbcTemplate.query(QueriesMenu.QRY_GET_CHLIDS_BY_PARENT, new Object[]{
                              menu1.getIdPadre(),
                              username,
                              menu1.getIdPadre(),
    ...
    private List<Menu> getParents() {
        return this.jdbcTemplate.query(QueriesMenu.QRY_GET_PARENTS_BY_USER, ((rs, i) -> mapperMenuParent(rs)));
